...
def main():
    ...
    wav_root = Counter([os.path.dirname(p) for p in wavs]).most_common(1)[0][0]
    ...
    g["filepath"] = g["audio_filename"].apply(lambda f: os.path.join(wav_root, f))
